...
class RepositoryDetailUITest: XCTestCase {
    ...
    func repoDetail() throws {
        ...
        forksButton.tap()
        app/*@START_MENU_TOKEN@*/.buttons["Wanted Help"]/*[[".segmentedControls[\"scopeBar\"].buttons[\"Wanted Help\"]",".buttons[\"Wanted Help\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
